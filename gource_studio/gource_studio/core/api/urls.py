...
urlpatterns = [
    ...
    re_path(r'^avatars/(?P<avatar_id>\d+)/aliases/?$', views.UserAvatarAliasesList.as_view(), name='api-useravataraliases-list'),
    re_path(r'^avatars/(?P<avatar_id>\d+)/aliases/(?P<avatar_alias_id>\d+)/?$', views.UserAvatarAliasDetail.as_view(), name='api-useravataralias-detail'),
    ...
    re_path(r'^info/?$', views.ApplicationInfo.as_view(), name='api-app-info'),
    ...
    re_path(r'^projects/(?P<project_id>\d+)/avatars/(?P<project_avatar_id>\d+)/aliases/?$', views.ProjectUserAvatarAliasesList.as_view(), name='api-project-useravataraliases-list'),
    re_path(r'^projects/(?P<project_id>\d+)/avatars/(?P<project_avatar_id>\d+)/aliases/(?P<avatar_alias_id>\d+)/?$', views.ProjectUserAvatarAliasDetail.as_view(), name='api-project-useravataralias-detail'),
